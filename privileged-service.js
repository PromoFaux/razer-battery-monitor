...
const USB_WORKER_PATH = path.join(__dirname, 'com.promofaux.razer-battery-monitor.sdPlugin', 'bin', 'usb-worker.cjs');
...
const server = http.createServer((req, res) => {
    ...
    if (url.pathname === '/devices') {
        ...
        const worker = spawn('node', [USB_WORKER_PATH, 'list'], {
        ...
        const args = ['node', USB_WORKER_PATH, 'battery'];
        if (deviceId) {
            args.push(deviceId);
        }
